...
ga_params = add_param(ga_params,'minbound',[0.5;   0.25; 10; 0.45; 15; -8.50*ones(6,1)]); //-0.5*ones(12,1)]);
ga_params = add_param(ga_params,'maxbound',[3.5;  25;    16; 1.55; 25; +8.50*ones(6,1)]); // +0.5*ones(12,1)]);
