...
ga_params = add_param(ga_params,'minbound',[2.5;  24.25; 20; 0.45; 15; -2.50*ones(6,1)]); //-0.5*ones(12,1)]);
ga_params = add_param(ga_params,'maxbound',[3.5;  25;    32; 1.45; 20; +2.50*ones(6,1)]); // +0.5*ones(12,1)]);
...
for ii= 1:PF_size; 
    [G,b,s] = circulation(101,rho,u(ii),L,ar(ii),cl(ii),0.0,A2TA(ii),0.0,A4TA(ii),0.0,A6TA(ii)); 
    ww=inducedvelocity(101,b,G);
