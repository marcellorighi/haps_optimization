...
*/
    ...
    [G,b,s] = circulation(n,rho,u,l_trailer,ar,cl_avg,A1,A2,A3,A4,A5,A6);
    ww    = inducedvelocity(n,b,G);
    ww_2  = ww($:-1:1);
    [G_LA,b,s] = circulation(n,rho,u,l_leader,ar,cl_avg,A1_LA,A2_LA,A3_LA,A4_LA,A5_LA,A6_LA);
...
ga_params = add_param(ga_params,'minbound',[0.5;   0.25; 10; 0.45; 15; -8.50*ones(6,1); 700]); //-0.5*ones(12,1)]);
ga_params = add_param(ga_params,'maxbound',[3.5;  25;    16; 1.55; 25; +8.50*ones(6,1); 900]); // +0.5*ones(12,1)]);
...
//    A5TA(ii)=a(13);
    ...
    lift_trailers(ii) = a(12); 
    lift_leader(ii)   = L*4 - lift_trailers(ii)*3;    
end
