...
ga_params = add_param(ga_params,'minbound',[0.5;   -10.0;   10; 0.45; 15; -0.0025*ones(ne-1,1); -0.0025*ones(ne-1,1)]); //-0.5*ones(12,1)]);
ga_params = add_param(ga_params,'maxbound',[1.5;    -0.15;  32; 1.25; 45; +0.0025*ones(ne-1,1); +0.0025*ones(ne-1,1)]); // +0.5*ones(12,1)]);
